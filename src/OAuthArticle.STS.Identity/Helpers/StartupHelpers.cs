...
using OAuthArticle.STS.Identity.Configuration;
using OAuthArticle.STS.Identity.Configuration.ApplicationParts;
using OAuthArticle.STS.Identity.Configuration.Constants;
using OAuthArticle.STS.Identity.Configuration.Interfaces;
using OAuthArticle.STS.Identity.Helpers.Localization;
using OAuthArticle.STS.Identity.Services;

namespace OAuthArticle.STS.Identity.Helpers
{
